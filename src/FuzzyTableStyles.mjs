const defaultClasses = {
    ...
    searchInput: 'relative indent-6 block w-full h-12 px-4 text-sm shadow-lg border border-stone-400 dark:border-stone-800 dark:bg-stone-700 text-stone-800 dark:text-stone-300 placeholder-stone-800 dark:placeholder-stone-100 ltr:rounded-tr-xl rtl:rounded-tr-xl',
    searchIcon: 'absolute block w-6 h-6 z-30 mt-3 mr-2 text-white',
